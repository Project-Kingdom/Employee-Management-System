...
router.post('/search/', function(req, res, next) {
  ...
  if(flrtName !='' && flrtEmail !='' && fltremptype !='' ){
   ...
   var flterParameter={ $and:[{ name:{$regex:flrtName}},
  {$and:[{email:flrtEmail},{etype:fltremptype}]}
  ]
   }
  }else if(flrtName !='' && flrtEmail =='' && fltremptype !=''){
    var flterParameter={ $and:[{ name:{$regex:flrtName}},{etype:fltremptype}]
       }
  }else if(flrtName =='' && flrtEmail !='' && fltremptype !=''){
...
//   var flrtName = req.body.fltrname;
//   var flterParameter={name:{ '$regex': '^'+flrtName, '$options': 'i' }};
//   console.log(flterParameter);
//   var employeeFilter =uploadModel.find(flterParameter);
//   console.log(employeeFilter);
//   employeeFilter.exec(function(err,data){
//       if(err) throw err;
//       res.render('upload-file', { title: 'Employee Records', records:data });
//         });
